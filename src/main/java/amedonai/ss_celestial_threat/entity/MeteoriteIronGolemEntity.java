...
public class MeteoriteIronGolemEntity extends IronGolemEntity {
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(3, new ActiveTargetGoal<>(this, MobEntity.class, 5, false, false, (livingEntity) -> livingEntity instanceof Monster));
    ...
    public boolean tryAttack(Entity target) {
        ...
        boolean hasDealtDamage = target.damage(this.getDamageSources().mobAttack(this), damageAmount);
